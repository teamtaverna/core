...
from .utils import (create_admin_account, admin_test_credentials,
                    normal_user_credentials, create_normal_user_acount,)
...
class ApiViewTest(TestCase):
    ...
    def create_api_key(self):
        uname, email, passwd = admin_test_credentials
    ...
    def test_api_key_issuance_handler_with_normal_user_credentials(self):
        uname, email, passwd = normal_user_credentials
        response = self.client.post(
            self.api_key_issuance_endpoint,
